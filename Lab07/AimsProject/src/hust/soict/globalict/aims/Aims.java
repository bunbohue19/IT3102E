				...
				case 3:
					for (int i = 0; i < listOfMedias.size(); i++) {
						...
						if (media instanceof Book) {
							...
							System.out.println(" - Director: " + ((CompactDisc) media).getDirector() + " - Length: " + ((CompactDisc) media).getLength() + " - Artist: " + ((CompactDisc) media).getArtist() + " - Tracks: " + ((CompactDisc) media).tracksInfo());
